...
<?php include'header.php';?>
	<main id="mensagem-presidente" class="sigle mensagem-presidente" tabindex="-1" role="main">
		<section class="banner">
			<article class="titulo">
				...
				<div class="box container">
					<h1>Mensagem da<br> presidente</h1>
					<p>XXX 000-00</p>
				</div>
		...
		<section class="conteudo">
			<div class="container">
				<article>
					...
					<p><b>LEIA A ÍNTEGRA</b> da mensagem de <b>Roberto Simões</b> , Presidente do Conselho Deliberativo do Sebrae Minas, na página 7  do <b>Relatório de Sustentabilidade 2021</b>.</p>
				</article>
				<aside>
					<div class="texto">
