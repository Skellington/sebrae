...
<title>Atendimento de qualidade</title>
<?php include'header.php';?>
	<main id="atendimento-qualidade" class="sigle atendimento-qualidade" tabindex="-1" role="main">
		<section class="banner">
			<article class="titulo">
				...
				<div class="box container">
					<h1>Atendimento de<br>qualidade</h1>
					<p>XXX 000-00</p>
				</div>
		...
		<section class="conteudo">
			<div class="container">
				<article>
					<p>A reformulação dos portais de atendimento foi uma das grandes ações implementadas, viabilizando a transformação digital interna e externamente.  Como o reforço à Rede de Atendimento <b>Aqui Tem Sebrae</b> que em 2021 fez 81.272 atendimentos e ganhou novos serviços. O atendimento destacou-se ainda com o projeto <b>Sebrae na sua Empresa</b> (SNSE), que foi responsável pelo atendimento de 46.780 pequenos negócios em 685 municípios.</p>

					<p>Entre os canais de contato, estão o SAC e a Ouvidoria. O primeiro dá voz ao cliente, tentar compreender suas di¬ficuldades para minimizar as recorrências e melhorar rotinas e processos internos. Já a Ouvidoria, além de ficar encarregada de questões não solucionadas por outras instâncias, atua na melhoria de processos, no atendi¬mento e no relacionamento com os seus stakeholders internos e externos.</p>

					<p><a href="">SAIBA MAIS</a> sobre esses e outros canais do Sebrae Minas no <a href="">Relatório de Sustentabilidade 2021.</a></p>
				</article>
				<aside>
					<div class="texto">
