...
<title>Desempenho do ano</title>
<?php include'header.php';?>
	<main id="desempenho-ano" class="sigle desempenho-ano" tabindex="-1" role="main">
		...
		<section class="conteudo">
			<div class="container">
				<article>
					...
					<p>A versão completa do Relatório de Sustentabilidade 2021 do Sebrae Minas, disponível para download neste link, traz detalhes a respeito de sete projetos de Suporte Empresarial, além dos principais eventos, e de 10 projetos de Desenvolvimento Econômico. Acesse e compartilhe!</p>
				</article>
				<aside>
					<div class="texto">
