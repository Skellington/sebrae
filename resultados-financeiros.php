...
<title>Resultados financeiros</title>
<?php include'header.php';?>
	<main id="resultados-financeiros" class="sigle resultados-financeiros" tabindex="-1" role="main">
		<section class="banner">
			<article class="titulo">
				...
				<div class="box container">
					<h1>Resultados<br>financeiros</h1>
					<p>XXX 000-00</p>
				</div>
		...
		<section class="conteudo">
			<div class="container">
				<article>
					<p>Em 2021, a Diretoria Executiva publicou o documento Estratégia Sebrae Minas 2021-2023, com os principais objetivos estratégicos:</p>
					<ol>
						<li>Escalar a base de Micro e Pequenas Empresas mineiras atendidas;</li>
						<li>Reduzir a mortalidade de Micro e Pequenas Empresas mineiras atendidas;</li>
						<li>Ampliar as receitas próprias no Vetor Social;</li>
						<li>Gerar margem de contribuição com produtos empresarias;</li>
						<li>Otimizar gastos.</li>
					</ol>
						<p>R$ 289 milhões de receitas em 2021, 21,3% a mais que em 2020</p>
						<p>58,73% do valor econômico distribuído em 2021 foi dedicado a custos operacionais.</p>
					

					<p><b>CONFIRA</b> os demais resultados financeiros do Sebrae Minas na página 47 do <a href="">Relatório de Sustentabilidade 2021.</a></p>
